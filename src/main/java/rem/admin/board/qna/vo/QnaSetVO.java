package rem.admin.board.qna.vo;

public class QnaSetVO {
    private int qna_no;
	private int mem_no;
	private String qna_title;
	private int qna_type;
	private String qna_at;
	private String qna_cont;
	private int qna_status;
	private int qna_com_status;
	private String cmt_cont;
	private String cmt_at;
	...
	public int getQna_com_status() {
		return qna_com_status;
	}
	public String getCmt_cont() {
		return cmt_cont;
	}
	public String getCmt_at() {
		return cmt_at;
	}
	...
	public void setQna_at(String qna_at) {
		this.qna_at = qna_at;
	}
	...
	public void setQna_com_status(int qna_com_status) {
		this.qna_com_status = qna_com_status;
	}
	public void setCmt_cont(String cmt_cont) {
		this.cmt_cont = cmt_cont;
	}
	public void setCmt_at(String cmt_at) {
		this.cmt_at = cmt_at;
	}
